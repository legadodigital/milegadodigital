...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('contactos-confianza.store'), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Añadir Contacto de Confianza</h2>}
        >
            <Head title="Añadir Contacto de Confianza" />
                        ...
                        <div className="p-6 text-gray-900">
                            <form onSubmit={submit} className="mt-6 space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    <PrimaryButton disabled={processing}>Guardar Contacto</PrimaryButton>
                                </div>
                            </form>
                        </div>
                    </div>
