...
export default function PlanEdit({ auth, plan: initialPlan }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.plans.update', initialPlan.id), {
            onSuccess: () => alert('Plan actualizado exitosamente!'),
            onError: (errors) => console.error('Error updating plan:', errors),
        });
    };
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar Plan</h2>}
        >
