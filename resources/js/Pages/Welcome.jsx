        ...
        <>
            ...
            >
                    ...
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        <div className="flex items-center">
                            <Link href="/" className="flex items-center">
                                ...
                                <span className="text-xl font-bold">Mi Legado Digital</span>
                            </Link>
                        </div>
                        <nav className="hidden md:flex space-x-6">
                            <a href="#inicio" className="hover:text-gray-300 transition duration-300">Inicio</a>
                        ...
                        <div className="hidden md:flex space-x-4">
                            {auth.user ? (
                                <Link
                                    ...
                                    className="font-semibold text-white hover:text-gray-200 focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition duration-300"
                                >
                                    Dashboard
                                </Link>
                            ) : (
                                <>
                                    ...
                                    <Link
                                        href={route('register')}
                                        className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition duration-300"
                                    >
                                        Registrarse
                                    </Link>
                                </>
                ...
                <div className="relative pt-20"> {/* Adjusted padding for fixed header */}
                    ...
                    <section id="inicio" className="relative flex items-center justify-center min-h-[calc(100vh-80px)] text-white text-center p-6">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-4 animate-fade-in-up">
                                Mi Legado Digital: Tu Voz, Tu Historia, Para Siempre.
                            </h1>
                            ...
                            <Link
                                href={route('register')}
                                className="inline-block px-8 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105 animate-fade-in-up animation-delay-400"
                            >
                                Crea tu Legado Hoy
                            </Link>
                        </div>
                    ...
                    {/* Features Section */}
                    <section id="caracteristicas" className="py-16 bg-gray-100 text-gray-800">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            <h2 className="text-4xl font-bold mb-12">¿Qué puedes hacer con Mi Legado Digital?</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                ...
                                <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                                    ...
                                    <h3 className="text-xl font-semibold mb-2">Recuerdos Digitales</h3>
                                ...
                                <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                                    ...
                                    <p className="text-gray-600">Designa a las personas que gestionarán tu legado digital.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="quienes-somos" className="py-16 bg-white text-gray-800">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            ...
                            <p className="text-lg leading-relaxed mt-4 max-w-3xl mx-auto">
                                En Mi Legado Digital, combinamos tecnología innovadora con un profundo respeto por la privacidad y la seguridad. Nos esforzamos por crear una experiencia intuitiva y significativa, permitiendo a nuestros usuarios construir un legado digital duradero que trascienda generaciones.
                            </p>
                        </div>
                    </section>

                    {/* How It Works Section */}
                    <section id="como-funciona" className="py-16 bg-gray-100 text-gray-800">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            <h2 className="text-4xl font-bold mb-12">¿Cómo funciona Mi Legado Digital?</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                                    ...
                                    <p className="text-gray-600">Regístrate de forma segura y comienza a construir tu legado digital.</p>
                                </div>
                                <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
                    ...
                    <section id="testimonios" className="py-16 bg-white text-gray-800">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            <h2 className="text-4xl font-bold mb-12">Lo que dicen nuestros usuarios</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                                    <p className="text-lg italic mb-4">"Mi Legado Digital me dio la tranquilidad de saber que mis palabras llegarán a mis seres queridos cuando yo ya no esté. Es un servicio invaluable."</p>
                                    <p className="font-semibold text-blue-600">- María G.</p>
                                </div>
                                <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                                    ...
                                    <p className="font-semibold text-blue-600">- Juan P.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="precios" className="py-16 bg-gray-100 text-gray-800">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                {plans.map((plan) => (
                                    <div key={plan.id} className="bg-white p-8 rounded-lg shadow-lg flex flex-col transform transition duration-300 hover:scale-105">
                                        <h3 className="text-2xl font-bold mb-4 text-blue-600">{plan.name}</h3>
                                        ...
                                        <ul className="mb-6 space-y-3">
                                            {plan.features.map((feature) => (
                                                <li key={feature.id} className="flex items-center text-gray-700">
                                                    ...
                                                    <span className="font-medium">{feature.feature_code.replace(/_/g, ' ')}:</span> {feature.value}
                                                </li>
                                            ))}
                                        </ul>
                                        <Link
                                            href={route('register')} // Or a specific plan registration route
                                            className="mt-auto block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300"
                                        >
                                            Elegir Plan
                                        </Link>
                                    </div>
                    ...
                    {/* Contactenos Section */}
                    <section id="contactenos" className="py-16 bg-white text-gray-800">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            ...
                            <div className="mt-8 flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
                                <a href="mailto:info@legadodigital.com" className="text-blue-600 hover:text-blue-800 text-lg font-semibold flex items-center transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    info@legadodigital.com
                                </a>
                                <a href="tel:+1234567890" className="text-blue-600 hover:text-blue-800 text-lg font-semibold flex items-center transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <footer className="bg-gray-800 text-white py-8">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center text-sm">
                            <div className="text-center sm:text-left mb-4 sm:mb-0">
                                <p>&copy; {new Date().getFullYear()} Mi Legado Digital. Todos los derechos reservados.</p>
                            </div>
                            <div className="flex items-center space-x-4">
                                ...
                                >
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        strokeWidth="1.5"
                                        className="-mt-px mr-1 w-5 h-5 stroke-white group-hover:stroke-gray-400"
                                    >
                                        <path
                                            strokeLinecap="round"
